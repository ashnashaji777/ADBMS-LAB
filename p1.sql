 ...
 desc dtable;
 SHOW TABLES;
INSERT etable values(101,'ashna',30/06/01,'fdhahfhsk',1236547896,12,78223,'manager');
SELECT *FROM ETABLE;
INSERT etable values(102,'joshna',1/2/01,'gcjsskjvh',1478523698,32,200000,'ceo');
SELECT * from etable;
